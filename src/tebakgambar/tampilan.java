...
public class tampilan extends javax.swing.JFrame {
    ...
    // menyimpan jawaban dari gambar
    String jawaban[] = {"akar_rumput", "pulang_kandang", "sholat_lima_waktu", "rexona", "patah_hati", "lidah_buaya", "kaki_gunung", "jam_karet", "demam_berdarah", "daun_bayam", "burung_dara", "mata_pisau", "tua_bangka", "obat_nyamuk", "persentase_biaya", "distribusi_daging", "salon_minimalis", "radiasi_matahari", "fermentasi_anggur", "pelampung_renang", "tangan_kesemutan", "hidup_mewah", "lebih_baik", "polisi_tidur", "senam_otak", "mati_rasa", "jam_kosong", "iga_bakar", "kucing_belang", "son_haji"};
...
//    subroutine untuk sorting
    ...
    private void initComponents() {
        ...
        gambar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tebakgambar/UI/akar_rumput.png"))); // NOI18N
    ...
    private void btnCekActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCekActionPerformed
        ...
        if (posisi > jawaban.length - 1) {
            ...
            gambar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tebakgambar/UI/" + jawaban[posisi] + ".png")));
        }
